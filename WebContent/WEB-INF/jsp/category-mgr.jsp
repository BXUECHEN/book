  ...
  <body>
    	...
    	<div id="main">
			<div class="section-left">
				...
				<table class="table" cellspacing="0">
			    	...
			    	<c:forEach items="${categories }" var="cate">
			    		<tr id="${cate.CID }">
			    			<td>${cate.CName}</td>
			    			<td><a href="#"  onclick="deleteCategory(${cate.CID})">删除</a></td>
			    		</tr>	
			    	</c:forEach>		    	    			    			    
			    </table>
			...
			<div class="section-right">
				...
				<form action="<%=application.getContextPath() %>/category/add" method="post">
					<p>分类名称：<input type="text" name="CName"  /><input type="submit" value=" 保 存 "  /></p>
					<p style="color:red">${Msg }</p>						
			    </form>
			</div>		
			<div class="cf"></div>
	...
	<script type="text/javascript">
		function deleteCategory(cid){
			...
			xmlhttp.open("get","${path}/category/delete?CID="+cid,true);
			xmlhttp.send();
		}
	</script>
  </body>
